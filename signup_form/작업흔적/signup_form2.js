...
// --------------------
    ...
    // formData.append('email', email);
    // formData.append('phoneNumber', phoneNumber);
    // formData.append('profileImage', profileImage); // 파일 전송
    // formData.append('userState', userState);
    ...
    //                 throw new Error('Network response was not ok');
    //             }
    //             return response.text(); // JSON 대신 text로 응답을 받음
    //         })
    //         .then(data => {
    //             try {
    //                 const jsonData = JSON.parse(data); // 응답이 JSON 형식인지 확인
    //                 console.log('서버 응답 (JSON):', jsonData);
    //             } catch (error) {
    //                 console.log('서버 응답 (텍스트):', data); // JSON 형식이 아니면 그대로 출력
    //             }
    //         })
    //         .catch(error => {
    //             console.log('Error:', error);
